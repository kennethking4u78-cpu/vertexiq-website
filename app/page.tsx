export default function VertexIQSystemsWebsite() {
  ...
  const ukWhatsappHref = `https://wa.me/${brand.ukWhatsappNumber}`;
  const ghWhatsappHref = `https://wa.me/${brand.ghWhatsappNumber}`;
    ...
    <div className="min-h-screen bg-[#040714] text-white">
      ...
      <section className="mx-auto max-w-7xl px-6 py-20">
        <h1 className="text-5xl md:text-7xl font-black leading-tight">
          We Build <span className="bg-gradient-to-r from-[#6C4CF1] to-[#2EA8FF] bg-clip-text text-transparent">
        ...
        <div className="mt-8 flex gap-4 flex-wrap">
          ...
          <a href={ukWhatsappHref} target="_blank" className="px-6 py-4 rounded-2xl border border-white/20">
            WhatsApp
          </a>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-6 py-20" id="contact">
        <div className="overflow-hidden rounded-[2rem] border border-white/10 bg-gradient-to-br from-[#0a1f44] to-[#060b1b] shadow-2xl">
          ...
          <div className="grid gap-10 p-8 md:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-5 text-slate-300">
                Reach out to VertexIQ Systems to discuss your project.
              </p>
              ...
              <div className="mt-8 grid gap-4 md:grid-cols-2">
                ...
                <div className="rounded-xl border border-white/10 bg-white/5 p-4">
                  ...
                  <a href={`mailto:${brand.email}`} className="mt-2 block break-words font-semibold">
                    {brand.email}
                  </a>
                </div>
                ...
                <div className="rounded-xl border border-white/10 bg-white/5 p-4">
                  ...
                  <a href={ukWhatsappHref} target="_blank" className="mt-2 block font-semibold">
                    +44 7376 174981
                  </a>
                </div>
                ...
                <div className="rounded-xl border border-white/10 bg-white/5 p-4">
                  ...
                  <a href={ghWhatsappHref} target="_blank" className="mt-2 block font-semibold">
                    +233 534 177 839
                  </a>
                </div>
