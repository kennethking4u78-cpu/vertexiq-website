          ...
          <div className="grid gap-10 px-8 py-10 md:grid-cols-[1fr_0.95fr] md:px-12 md:py-14">
            <div>
              ...
              <div className="mt-8 grid gap-4 sm:grid-cols-3">
                <div className="rounded-[1.4rem] border border-white/10 bg-white/5 p-4">
                  ...
                  <a href={`mailto:${brand.email}`} className="mt-2 block text-sm font-semibold text-white hover:text-[#b8cfff]">
                    {brand.email}
                  </a>
                </div>
                <div className="rounded-[1.4rem] border border-white/10 bg-white/5 p-4">
                  <p className="text-sm text-slate-400">WhatsApp</p>
                  <a href={whatsappHref} target="_blank" rel="noreferrer" className="mt-2 block text-sm font-semibold text-white hover:text-[#b8cfff]">
                    Chat directly
                  </a>
                </div>
                <div className="rounded-[1.4rem] border border-white/10 bg-white/5 p-4">
                  <p className="text-sm text-slate-400">Consultation</p>
                  <a href={brand.calendlyUrl} target="_blank" rel="noreferrer" className="mt-2 block text-sm font-semibold text-white hover:text-[#b8cfff]">
                    Book a call
                  </a>
                </div>
              </div>
            ...
            <div className="rounded-[1.9rem] border border-white/10 bg-white/5 p-7 backdrop-blur">
              <div className="space-y-5">
                ...
                <input className="w-full rounded-2xl border border-white/10 bg-[#050816] px-5 py-4 outline-none placeholder:text-slate-500" placeholder="What do you need built?" />
                <textarea className="min-h-[150px] w-full rounded-2xl border border-white/10 bg-[#050816] px-5 py-4 outline-none placeholder:text-slate-500" placeholder="Tell us about your project" />
                <div className="grid gap-4 sm:grid-cols-2">
                  <a
                    href={brand.calendlyUrl}
                    target="_blank"
